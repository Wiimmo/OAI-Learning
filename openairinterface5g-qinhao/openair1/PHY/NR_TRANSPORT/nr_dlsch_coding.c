		      ...
		      time_stats_t *dlsch_segmentation_stats)
{
  ...
  LOG_D(PHY,"dlsch coding A %d G %d (nb_rb %d, nb_symb_sch %d, nb_re_dmrs %d, length_dmrs %d, mod_order %d), a %p\n", 
        A,G, nb_rb,nb_symb_sch,nb_re_dmrs,length_dmrs,(int)mod_order, a);
  if (A > 3824) {
